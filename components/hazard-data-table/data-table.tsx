...
export function HazardDataTable<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div>
      <div className="flex items-center py-4">
        <Input
          placeholder="Filter Ticket Number..."
          value={(table.getColumn("hazard_id")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("hazard_id")?.setFilterValue(event.target.value)
          }
          className="max-w-sm"
        />
